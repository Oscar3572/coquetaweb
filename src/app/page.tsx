      ...
      <section id="contacto" className="px-6 py-16 bg-[#FDE9EF] text-[#4B2E2E]">
        ...
        <div className="text-center mt-10">
          ...
          <div className="mt-8 flex justify-center gap-6">
            {/* Instagram */}
            <a href="https://www.instagram.com/coqueta_bynicolle/?igsh=YWFuZW13cnE3eDc2" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="bg-pink-100 hover:bg-pink-200 p-3 rounded-full shadow-md transition-transform transform hover:scale-110">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/share/1GQatn9G74/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="bg-blue-100 hover:bg-blue-200 p-3 rounded-full shadow-md transition-transform transform hover:scale-110">
            ...
            {/* TikTok */}
            <a href="https://www.tiktok.com/@coquetabynicolle?._t=ZM-8x8NAdba62X&_r=1" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="bg-gray-100 hover:bg-gray-200 p-3 rounded-full shadow-md transition-transform transform hover:scale-110">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/50235724563" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="bg-green-100 hover:bg-green-200 p-3 rounded-full shadow-md transition-transform transform hover:scale-110">
      ...
      <footer className="bg-[#F7A8B8] text-[#4B2E2E] px-6 py-10 mt-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold">COQUETA <span className="italic font-normal">by Nicolle</span></span>
          </div>
